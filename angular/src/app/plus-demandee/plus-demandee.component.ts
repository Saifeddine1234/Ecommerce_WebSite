...
@Component({
  selector: 'app-plus-demandee',
  templateUrl: './plus-demandee.component.html',
  styleUrls: ['./plus-demandee.component.scss']
})
export class PlusDemandeeComponent implements OnInit {
  url : any ;
  produits  :  any =[];
  cartproduit  :  any =[];
  panier  :  any =[];
